...
#NOMBRES MAL: from db.database import actualizar_precios_ves, grardar_log, get_session, obtener_productos, guardar_tasa, obtener_ultima_tasa
# from db.database import obtener_productos_activos, obtener_ultima_tasa, guardar_tasa
...
#TODO ARRIBA: from db.database import obtener_productos_activos
#TODO: ─── función manejar_menu ─────────────────────────────────────────────────────────────────
#TODO ANTES DEL LOGER: app.add_handler(CallbackQueryHandler(manejar_menu, pattern="^menu_"))  # TODO ← AGREGAR ESTA LÍNEA
...
def iniciar_bot():
    ...
    app.add_handler(CallbackQueryHandler(manejar_menu, pattern="^menu_"))  # TODO ← AGREGAR ESTA LÍNEA
    
    logger.info("Bot de Telegram iniciado.") #! Para la terminal
